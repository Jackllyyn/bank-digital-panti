...
<?php $__env->startSection('title', 'Catat Transaksi Barang Keluar'); ?>
                                ...
                                <div class="md:col-span-5">
                                    ...
                                    <select :name="'items['+index+'][barang_id]'" x-model="item.barang_id" @change="updateItem(index, $event)" required class="block w-full border border-gray-300 rounded-md shadow-sm text-sm focus:ring-green-500 focus:border-green-500 p-2">
                                        ...
                                        <?php $__currentLoopData = $barangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($b->id); ?>" data-price="<?php echo e($b->harga_beli_rata2); ?>" data-stok="<?php echo e($b->stok_saat_ini); ?>">
                            ...
                            <div>
                                ...
                                <select name="kode_akun_kas" class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm focus:ring-green-500 focus:border-green-500 px-3 py-2">
                                    ...
                                    <?php $__currentLoopData = $akunKas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ak): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($ak->kode_akun); ?>" <?php echo e(old('kode_akun_kas') == $ak->kode_akun ? 'selected' : ''); ?>>
                            ...
                            <div>
                                ...
                                <select name="kode_akun_pendapatan" class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm focus:ring-green-500 focus:border-green-500 px-3 py-2">
                                    ...
                                    <?php $__currentLoopData = $akunPendapatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ap): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($ap->kode_akun); ?>" <?php echo e(old('kode_akun_pendapatan') == $ap->kode_akun ? 'selected' : ''); ?>>
                            ...
                            <div>
                                ...
                                <select name="kode_akun_beban" class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm focus:ring-green-500 focus:border-green-500 px-3 py-2">
                                    ...
                                    <?php $__currentLoopData = $akunBeban; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($ab->kode_akun); ?>" <?php echo e(old('kode_akun_beban') == $ab->kode_akun ? 'selected' : ''); ?>>
                            ...
                            <div>
                                ...
                                <select name="kode_akun_persediaan" class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm focus:ring-green-500 focus:border-green-500 px-3 py-2">
                                    ...
                                    <?php $__currentLoopData = $akunPersediaan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ap): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($ap->kode_akun); ?>" <?php echo e(old('kode_akun_persediaan') == $ap->kode_akun ? 'selected' : ''); ?>>
                                            <?php echo e($ap->kode_akun); ?> - <?php echo e($ap->nama_akun); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\web-panti\resources\views/admin/penjualan-pemakaian-barang/create.blade.php ENDPATH**/ ?>