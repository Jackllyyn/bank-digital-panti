...
<div class="border-box">
    ...
    <table width="100%" style="margin-bottom: 10px;">
        <tr>
            ...
            <td align="right">Jenis: {{ $data->jumlah >= 0 ? 'PEMASUKAN' : 'PENGELUARAN' }}</td>
        </tr>
        <tr>
    ...
    <table class="table-detail">
        ...
        <tbody>
            ...
            <tr class="last-row">
                <td style="font-weight: bold; padding-left: 30px; padding-bottom: 10px;">{{ $data->akunKredit->nama_akun }}</td>
    ...
    <p><strong>Terbilang:</strong> <i> {{ $terbilang }} </i></p>
