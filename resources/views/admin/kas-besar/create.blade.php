@extends('layouts.app')
@section('title', 'Input Kas Besar Baru')
...
<div class="max-w-4xl mx-auto py-6">
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        ...
        <div class="px-6 py-5 bg-green-600 text-white">
            <div class="flex items-center">
                ...
                <div>
                    <h1 class="text-xl font-semibold">Input Kas Besar</h1>
    ...
    {{-- Transaksi --}}
     <div class="p-6">
            <form action="{{ route('admin.kas-besar.index') }}" method="POST" class="space-y-6">
                @csrf
