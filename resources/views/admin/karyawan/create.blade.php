...
<div class="max-w-3xl mx-auto px-4 py-8">
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
        <h1 class="text-2xl font-semibold text-gray-800 mb-6">Tambah Karyawan Baru</h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="jenis_karyawan"
                        ...
                        <option value="tetap" {{ old('jenis_karyawan') == 'tetap' ? 'selected' : '' }}>Tetap</option>
                        <option value="tidak tetap" {{ old('jenis_karyawan') == 'tidak tetap' ? 'selected' : '' }}>Tidak Tetap</option>
                        <option value="lainnya" {{ old('jenis_karyawan') == 'lainnya' ? 'selected' : '' }}>Lainnya</option>
                    </select>
                ...
                <div>
                    ...
                    <input type="number" name="gaji_pokok" value="{{ old('gaji_pokok', 0) }}" min="0"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                ...
                <div>
                    ...
                    <input type="number" name="tunjangan" value="{{ old('tunjangan', 0) }}" min="0"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                ...
                <div>
                    ...
                    <input type="number" name="potongan_gaji" value="{{ old('potongan_gaji', 0) }}" min="0"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
