...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('admin.pengurus.create') }}" class="bg-primary text-white px-4 py-2 rounded-lg hover:bg-primary-dark transition">
            + Tambah Pengurus
        </a>
    </div>
            ...
            <tbody class="divide-y divide-gray-200">
                @forelse($pengurus as $index => $item)
                    <tr>
                        ...
                        <td class="px-6 py-4">
                            @if($item->foto)
                                <img src="{{ asset('storage/' . $item->foto) }}" class="w-12 h-12 rounded-full object-cover" alt="{{ $item->nama }}">
                            @else
                        ...
                        <td class="px-6 py-4">
                            <a href="{{ route('admin.pengurus.edit', $item->id) }}" class="text-blue-600 hover:text-blue-900 mr-2">Edit</a>
                ...
                @empty
                    <tr>
                        <td colspan="7" class="px-6 py-4 text-center text-gray-500">Belum ada data pengurus.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
